...
quando não há um único efeito no tabuleiro (`artes-grid-mesa.ts:2121` · `function verificarEfeitos`). O
...
`semearMana()` (`grid.astro:3339`) faz **um UPDATE sequencial por combatente** sem
