...
quando não há um único efeito no tabuleiro (`artes-grid-mesa.ts:1939` · `function verificarEfeitos`). O
...
`semearMana()` (`grid.astro:3318`) faz **um UPDATE sequencial por combatente** sem
