...
quando não há um único efeito no tabuleiro (`artes-grid-mesa.ts:1995` · `function verificarEfeitos`). O
...
`semearMana()` (`grid.astro:3342`) faz **um UPDATE sequencial por combatente** sem
