...
quando não há um único efeito no tabuleiro (`artes-grid-mesa.ts:2116` · `function verificarEfeitos`). O
...
`semearMana()` (`grid.astro:3364`) faz **um UPDATE sequencial por combatente** sem
