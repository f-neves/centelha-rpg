...
// Subir e parar o dev server mora num lugar só: scripts/dev-server.mjs. Ele
// aguenta o Astro 5 (primeiro plano) e o 7 (daemon), e carrega o caminho do
// site, que muda quando o site sair do GitHub Pages.
