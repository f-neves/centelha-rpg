...
E o fato de a [Longa](/regras/acoes-e-sistema) ser uma **parede**, e não uma ladeira, é aqui o comportamento certo: quem tem média igual ou menor que a Dificuldade não termina nunca, por mais meses que passe na bigorna. **Paciência não faz uma lâmina melhor. Expertise faz.**
...
| **Intervalo** | o degrau em que aquele ofício respira |
...
Ofícios Gerais 4 faz porta, cerca, escudo, flecha e gambeson como se fosse do ramo; Ofícios Gerais 2 já não faz, e para ele a porta é peça de carpinteiro. Cada nível compra duas coisas ao mesmo tempo, um pool melhor e um território maior.
...
**Ninguém mantém uma forja acesa para fazer uma espada só.** Aquecer, preparar o carvão, temperar a água e arrumar as bancadas custa o mesmo para uma peça ou para oito, e só o trabalho da peça se repete. Por isso a Montagem entra uma vez por **lote**.
...
## A qualidade move os cinco números de uma vez

A peça sai **Comum** por padrão. A régua vai para os dois lados, e cada grau mexe em tudo.
...
São os ±2 e ±4 de circunstância, e no ofício eles são o principal caminho para a qualidade.
...
| Obra | Ofício | Req | Dif | Mont. | Peça | Piso |
|---|---|:--:|:--:|:--:|:--:|:--:|
...
Uma Espada Longa Ótima remendada no acampamento volta a cortar como uma espada Comum. Os graus voltam quando um ferreiro de verdade puser a mão nela.

**Melhorar.** Um grau de cada vez, com o Requisito, a Dificuldade e o intervalo do grau pretendido, e o Acúmulo de **metade** do que aquele grau custaria de novo. Uma espada Comum vira Boa por 17 em vez de 33. É por aqui que uma espada de saque vira a espada do personagem.

**Improvisar.** É **Direta** ou Acumulada em minutos, não Longa: uma tala, uma tocha, um arpéu com o que está na mochila. Dificuldade da peça **+4**, e o que sai é frágil, para **um uso** ou até o fim da cena.

**Desmontar.** Direta contra a Dificuldade da peça. Passando, recupera metade do material; com uma Margem, tudo o que era aproveitável.
...
- **Sobreviver no ermo.** Caçar, pescar, achar água, montar abrigo, ler o tempo. Direta, uma por dia, Percepção + Sobrevivência, e é a camada que **evita** o Ambiente.
- **Viajar.** Longa, intervalo de dia, com o Ambiente cobrando em paralelo.
- **Navegar.** Direta, Percepção + Navegação.
- **Administrar** terra, tropa ou negócio. Longa, Inteligência + Burocracia, intervalo de estação.
- **Comandar em batalha.** Direta, Influência + Liderança.
...
- **Preços e disponibilidade** estão em [Custo de Serviço & Itens](/regras/custo-de-servico-e-itens). Aqui se diz quanto tempo leva para fazer, não quanto custa para comprar.
