...
<div class="callout regra"><span class="lbl">Módulo opcional</span>O <strong>Fôlego</strong> é uma <strong>regra avançada</strong>: acrescenta gestão de cansaço ao combate, premiando quem alterna pressão e respiro em vez de atacar sem parar. Mesas iniciantes podem <strong>jogar Centelha sem ele</strong> — basta ignorar o custo e a recuperação de Fôlego, e nada mais no sistema quebra. Recomendado quando o grupo já domina o básico e quer mais textura tática.</div>
...
Você **recupera +Vigor de Fôlego por [Tick](/regras/combate) sempre que NÃO está numa ação que gaste Fôlego** — defender, recuar e esquivar não custam nada e deixam a reserva voltar; atacar e correr **gastam e não recuperam**. Por isso ninguém pressiona a luta inteira: alterna-se **rajada e respiro**, e quem tem mais Vigor volta ao ar mais rápido.

## Custo por golpe

Cada golpe custa o **Fôlego da arma** (também no catálogo e na ficha), fixado pela classe:

<div class="table-wrap">

| Classe da arma | Fôlego por golpe |
|---|:---:|
| Leve | 15 |
| Média | 24 |
| Pesada | 38 |
