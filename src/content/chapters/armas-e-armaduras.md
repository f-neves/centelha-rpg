...
- **Fôlego** — o **custo bruto** do golpe (leve **15**, médio **24**, pesado **35**). Como você recupera Vigor de Fôlego por Tick, no líquido o **golpe leve se paga** — e até regenera, para quem tem Vigor alto — enquanto o **pesado drena**. *(Qualquer golpe pode ser **forçado**: cada +1d6 dobra o Fôlego e soma +1 à Speed, sem teto — ver o **Esforço** em [Combate](/regras/combate).)*
...
| Pesada | 7 | 35 | 3d6 | +0 | −1 | 2 | dano que vence armadura — mas lenta e te expõe |
