...
export const NAV = [
  ...
  { slug: 'regras/defesas', titulo: 'As Três Defesas', numeral: 'VIII' },
  { slug: 'regras/quase-acerto', titulo: 'Quase-Acerto', numeral: 'IX' },
  { slug: 'regras/armas-e-armaduras', titulo: 'Armas & Armaduras', numeral: 'X' },
  { slug: 'regras/custo-de-servico-e-itens', titulo: 'Custo de Serviço & Itens', numeral: 'XI' },
  { slug: 'caminhos', titulo: 'As Proezas', numeral: 'XII' },
  { slug: 'arcano', titulo: 'O Arcano', numeral: 'XIII' },
  { slug: 'regras/folego', titulo: 'Fôlego', numeral: 'XIV' },
  { slug: 'regras/criacao-de-personagem', titulo: 'Criação de Personagem', numeral: 'XV' },
