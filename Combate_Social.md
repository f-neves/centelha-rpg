...
## 15. Regra opcional: Influência Estendida (a média e as Firulas)
...
Aqui você **não aposta no dado**: toma o resultado confiável e o empilha com **Firulas** até
...
bônus fixos (o +2 de soma ímpar, o Peso, a Centelha, as Firulas) continuam somando.
...
- **Passivo (o cortejo):** você toma a **média + Firulas acumuladas**, sem rolar a influência.
  Mais preparo, mais tempo, mais presentes e cuidado. Seguro (nunca retrocede), porém lento. O
  alvo vai caindo na teia.

### Firulas

Cada Firula (presente, elogio, favor, suborno, chantagem, um gesto atencioso) soma na média
...
**Firula Infeliz:** um gesto que **desagrada** subtrai na mesma escala (vacilo leve −1, desagrado
claro −2, ofensa grave −4, e o Mestre pode virar Desfavor na régua).

**Trava anti-abuso:** no máximo **uma Firula de cada nível por período** (teto de **+7**:
0+1+2+4). Firulas repetidas caem de nível, e um alvo que percebe o interesse óbvio fica
...
- **A cada 6 de folga** na leitura, descobre **+1 ponto** do que ainda falta, até o valor exato.
  Uma leitura brilhante te diz quantas Firulas faltam; uma apertada só diz "ainda não".

A assimetria é o charme: a sua **influência é confiável** (média), mas **saber se pegou é
incerto** (você rola a leitura). Ler mal faz você parar cedo (e falhar) ou gastar Firulas à toa.

### Tempo e ritmo

Cada Firula **leva tempo** (um +1 é rápido; um +3 é uma empreitada). O intervalo-base **escala
...
passos na régua (`Regua_Relacao.md`). Mas vale o **teto de vidro**: ataques e Firulas sozinhos
levam a régua só até **±2**; subir a +3/+4/+5 (arriscar a vida por você) exige um **vínculo**
de verdade (uma Intimacy, uma lealdade), de marco narrativo, não de contar Firulas. E **favor
