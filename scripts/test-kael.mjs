...
const esquiva = 3, espEsq = 0, prontidao = 3, cent = 2, vont = 7, integridade = 0, corrida = 3;
...
const esperado = { pv: 37, defesa: 18, defM: 11, energia: 24, mana: 11, folego: 44, ini: 6, deslArr: 7, deslCor: 9, deslNor: 4, saltoV: 176, saltoHP: 3, saltoHC: 11 };
...
console.log('✓ Regressão Kael OK — PV 37 · Defesa 18 · Def. Mental 11 · Energia 24 · Mana 11 · Fôlego 44 · Iniciativa 1d6+6 · Arranque 7/Corrida 9 m·s · Livre 4 m · Salto V176/HP3/HC11.');
