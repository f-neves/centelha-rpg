...
const NPCS = [
  ...
  { id: 'arqueiro', nome: 'Arqueiro', tipo: 'soldado', ameaca: 2, centelha: 0,
    ...
    armadura: { soak: 2, prot: 1, esquiva: 0 },
    ataques: [{ nome: 'Arco', atrib: 'destreza', pericia: 'atirador', dado: 2, distancia: true, tipo: 'perfurante', acerto: 1, pen: 2, ticks: 6 }],
  ...
  { id: 'bruto', nome: 'Bruto', tipo: 'soldado', ameaca: 3, centelha: 0,
    ...
    armadura: { soak: 2, prot: 1, esquiva: 0 },
    ataques: [{ nome: 'Martelo de guerra', atrib: 'forca', pericia: 'armas-duas-maos', dado: 3, mao: 2, tipo: 'impacto', acerto: 0, ticks: 7, notas: 'Ruptura: ignora Soak de armadura' }],
  ...
  { id: 'assassino-das-sombras', nome: 'Assassino das Sombras', tipo: 'elite', ameaca: 4, centelha: 1,
    ...
    armadura: { soak: 2, prot: 1, esquiva: 0 },
    ataques: [{ nome: 'Adaga (Ágil, Perf. 2)', atrib: 'destreza', pericia: 'armas-uma-mao', dado: 1, mao: 1, tipo: 'perfurante', acerto: 2, pen: 2, ticks: 5, notas: 'Ágil: usa Destreza no dano' }],
  ...
  { id: 'duelista', nome: 'Duelista', tipo: 'elite', ameaca: 4, centelha: 1,
    ...
    armadura: { soak: 2, prot: 1, esquiva: 0 },
    ataques: [{ nome: 'Florete (Ágil, Perf. 1)', atrib: 'destreza', pericia: 'armas-uma-mao', dado: 1, mao: 1, tipo: 'perfurante', acerto: 2, pen: 1, ticks: 5 }],
  ...
  { id: 'ogro', nome: 'Ogro', tipo: 'chefe', ameaca: 5, centelha: 0,
    ...
    armadura: { soak: 2 },
    ataques: [{ nome: 'Clava enorme', atrib: 'forca', pericia: 'armas-duas-maos', dado: 3, mao: 2, tipo: 'impacto', acerto: 0, ticks: 7, notas: 'Ruptura; derruba o alvo' }],
