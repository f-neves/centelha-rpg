...
const S = {
  ...
  tecnicas: z.object({ id: z.string(), nome: z.string(), caminho: z.string(), atributo: z.string(), banda: z.number().int().min(1).max(15), tipo: z.enum(['passiva', 'ativa', 'reflexiva']), custo, prereq: z.array(z.string()), aliases: z.array(z.string()), texto: z.string(), pendente: z.boolean() }),
