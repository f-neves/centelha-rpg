...
citação, `src/pages/mesa/grid.astro:4654` · `function grupoDaVez`, tem trinta e tantos caracteres), enquanto uma âncora
...
este achado: `grupoDaVez` (`grid.astro:4654`) tinha a âncora certa (`function grupoDaVez`) escrita
