...
| "não há lance em que o veredito não seja derivável" | há **três caminhos que devolvem `null`**: `lance.ts:143` (`if (alvo.defesaBase == null) return null`), `grid.astro:8657` (o ternário exige `soma != null && def2 != null`) e `grid.astro:8576` (`defesaBase: r?.defesa ?? null`) |
