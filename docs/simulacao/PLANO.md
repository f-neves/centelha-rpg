...
**A série do `L52` (abertos/fechados/parciais do `docs/pendencias/L-simulacao-simultaneo.md`) se remede no reset da semana
(quinta, 18h) e no fechamento de cada fase.** Primeira medida: 08/09/2026, 120 abertos · 63
fechados · 4 parciais · 187 no total (`docs/pendencias/L-simulacao-simultaneo.md` `L52`). Série sem data marcada morre na
