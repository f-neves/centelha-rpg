# Contrato da Auditora (equipe TechLead)

Escrito em 08/09/2026 a partir do que ela já operava, sem contrato escrito até aqui — o
mesmo defeito que o `TECHLEAD.md §6` cataloga ("cresce por decisão sem ninguém decidir
...
formular uma pergunta a partir do que viu; a resposta é do TechLead.

## Onde o achado mora

Tudo que ela afirma sobre estado do projeto vai para
`docs/simulacao/caixa/NN-auditora.md`, commitado pelo TechLead — a mensagem para o
TechLead anuncia que o arquivo está pronto, não é ela mesma o registro (mesmo princípio do
