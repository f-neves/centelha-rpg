...
def livre_frac(renda): return 0.20 * (60 / renda) ** 0.2
...
FAIXA_NIVEL = {"Braçal": "Pobre", "Destreinado": "Pobre", "Treinado": "Modesto", "Especialista": "Confortável",
               "Doutor": "Confortável", "Abastado": "Abastado", "Rico": "Rico", "Aristocrata": "Aristocrata", "Nobreza": "Aristocrata"}
...
MONTARIAS = [  # id, nome, pence, fonte, conf, nota, atual_pc
    ...
    ("burro", "Burro ou jumento", 100, "MtD", "B", "MtD 800 C. O catálogo tem 12 pp.", 120),
...
CRIACAO = [
    ...
    ("potro", "Cavalo de criação (não adestrado)", 200, "Langdon", "B", "O preço do cavalo de tração sem o preço do adestramento para sela.", 140),
]
ARREIOS = [
...
VEICULOS = [
    ("carroca", "Carroça de duas rodas", 300, "Catálogo", "B", "Hodges: carroça ferrada 4s (c. 1350) = 320. Mantido 3 po.", 300),
    ...
    ("barco-pesca", "Barco de pesca com vela", 3000, "Derivado", "C", "Sem fonte. Construção naval de semanas.", None),
